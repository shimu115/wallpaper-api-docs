import{_ as n,c as a,a as e,o as t}from"./app-DXPxTGqb.js";const l={};function i(p,s){return t(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="bing-start" tabindex="-1"><a class="header-anchor" href="#bing-start"><span>bing start</span></a></h1><h2 id="bing-今日图片" tabindex="-1"><a class="header-anchor" href="#bing-今日图片"><span>bing 今日图片</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">http://localhost:9123/api/bing/wallpaper/today</span>
